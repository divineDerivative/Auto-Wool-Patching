...
namespace AutoWool
{
    public class AutoWoolPatching : Mod
    {
        ...
        public AutoWoolPatching(ModContentPack content) : base(content)
        {
            ...
            harmony.PatchAll();
            ModManagement.RegisterMod("AutoWool.ModNameShort", typeof(AutoWoolPatching).Assembly.GetName().Name, new("0.9.0.8"), "<color=#00b7dc>[AutoWool]</color>", () => AutoWoolSettings.debugLogging);
        }
